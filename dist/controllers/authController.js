...
const registerUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const createdUser = yield (0, userModel_1.createUser)(user.id, email, username, displayName); // Ensure IDs match
        res.status(201).json({
            id: createdUser.id,
    ...
    `;
        ...
        res.json({
            ...
            user: {
                ...
                registrationId: userDetail === null || userDetail === void 0 ? void 0 : userDetail.registration_id,
                isVerified: userDetail === null || userDetail === void 0 ? void 0 : userDetail.is_verified,
                isAdmin: userDetail === null || userDetail === void 0 ? void 0 : userDetail.is_admin,
                name: userDetail === null || userDetail === void 0 ? void 0 : userDetail.display_name,
            },
        });
    }
    catch (err) {
...
const refreshToken = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const { data, error } = yield supabaseClient_1.supabase.auth.refreshSession({
